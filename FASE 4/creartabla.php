...
if (mysqli_query($conn, $sql)) {
    echo "<b>Tabla invitados creada satisfactoriamente</b>";
} else {
  
		echo '<script language="javascript">alert("Datos de la tabla ya fueron creados'.$dbname.'");window.location.href="index.html"</script>';
	  echo "<p>Error creando tabla:</p> " . mysqli_error($conn);
}
