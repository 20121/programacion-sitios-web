...
if (mysqli_num_rows($result) > 0) {
 ...
 echo "codigo:" . $row["codigo"]. "Nombre_Producto:" . $row["Nombre_Producto"]. "Marca_Producto:" . $row["Marca_Producto"]. "Precio_compra". $row["Precio_Compra"]. "Cantidad_Compra" . $row["Cantidad_Compra"]. "<br>";
...
<!-- The Modal-->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
          ...
          <button class="close" onclick="location.href='formulario4.html'">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
          La consulta se mostrado satisfactoriamente
        </div>
        
        <!-- Modal footer -->
     <div class="modal-footer">
          <button class="btn btn-danger" onclick="location.href='formulario4.html'">Cerrar</button>
        </div>
...
<!-- The Modal -->
  ...
  <div class="modal-header">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          Ingrese un codigo que ya exista
