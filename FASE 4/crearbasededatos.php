...
if (mysqli_query($conn, $sql)) {
	...
	echo '<script language="javascript">alert("Datos de la base datos fueron ya creados'.$sql.'");window.location.href="index.html"</script>';
	echo "<p>Error creando base de datos: </p>" . mysqli_error($conn);
