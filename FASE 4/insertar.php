...
<!-- The Modal-->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
          ...
          <button class="close" onclick="location.href='formulario1.html'">&times;</button>
        </div>
     ...
     <div class="modal-footer">
          <button class="btn btn-danger" onclick="location.href='formulario1.html'">Cerrar</button>
        </div>
...
<!-- The Modal -->
  ...
  <div class="modal-header">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          Los datos no pudieron ser grabados o el Codigo_Producto esta Repetido
...
if(mysqli_num_rows($verificar_codigo) > 0){
 ...
 //  echo '<script language="javascript">alert("Datos grabados satisfactoriamente'.$i.'");window.location.href="formulario1.html"</script>';
