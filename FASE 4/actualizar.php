...
$sql = "UPDATE Tabla301127_30 SET Nombre_Producto='$n', Marca_Producto='$a', Precio_Compra='$e', Cantidad_Compra='$o' WHERE codigo='$i'";
...
?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
          <h4 class="modal-title"><b>Excelente</b></h4>
          <button class="close" onclick="location.href='formulario2.html'">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
         <b> Datos grabados safisfactoriamente</b>
        </div>
        
        <!-- Modal footer -->
     <div class="modal-footer">
          <button class="btn btn-danger" onclick="location.href='formulario2.html'">Cerrar</button>
        </div>
...
?>
  ...
  <div class="modal-header">
        ...
        <!-- Modal body -->
        <div class="modal-body">
         <b> Los datos no pudieron ser grabados o el Codigo_Producto esta Repetido</b>
        ...
        <!-- Modal footer -->
      <div class="modal-footer">
          <button class="btn btn-danger" onclick="location.href='formulario2.html'"><b>Cerrar</b></button>
        </div>
 ...
 <?php
    ...
    echo "<b>Error actualizando la información:</b> " . mysqli_error($conn);
}
