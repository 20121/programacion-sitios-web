...
<!-- The Modal-->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
          ...
          <button class="close" onclick="location.href='formulario3.html'">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
          Datos grabados fueron eliminados safisfactoriamente
        </div>
        
        <!-- Modal footer -->
     <div class="modal-footer">
          <button class="btn btn-danger" onclick="location.href='formulario3.html'">Cerrar</button>
        </div>
