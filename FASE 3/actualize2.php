...
$sql = "UPDATE tabla301127_30 SET Nombre_Producto='$n', Marca_Producto='$a', Precio_Compra='$e', Cantidad_Compra='$i'  WHERE codigo='$Codigo'";

if (mysqli_query($conn, $sql)) {
    echo "<b>Información actualizada satisfactoriamente</b>";
} else {
